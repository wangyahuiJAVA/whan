package com.seata.instance.gateway.config;
...
public class RedisConfig {
    ...
    RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        setSerializer(template, serializer);
        return template;
    }
    ...
    private void setSerializer(RedisTemplate template, Jackson2JsonRedisSerializer serializer) {
